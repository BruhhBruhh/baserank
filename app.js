// Initialize Web3 with the Base Mainnet Alchemy HTTPS RPC endpoint
...
const contractABI = [
    ...
    {"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"userStakes","outputs":[{"internalType":"uint256","name":"term","type":"uint256"},{"internalType":"uint256","name":"maturityTs","type":"uint256"},{"internalType":"uint256","name":"amount","type":"uint256"},{"internalType":"uint256","name":"apy","type":"uint256"}],"stateMutability":"view","type":"function"},
...
// Log contract and its methods to debug
console.log('Contract:', cbXenContract);
console.log('Contract events:', cbXenContract.events);
